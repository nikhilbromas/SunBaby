...
interface Props {
  ...
  onOpenTableModal?: (type: "contentDetailTable", index?: number) => void;
}

export const ContentDetailTableEditor: React.FC<Props> = ({
  selectedElement,
  template,
  onUpdateContentDetailTable,
  onOpenTableModal,
  ...
  const updateColumn = (i: number, updates: Partial<TableColumnConfig>) => {
    ...
    onUpdateContentDetailTable(selectedElement.index, { ...table, columns });
  };
    ...
    <div className="px-4 py-2 border-b bg-white">
      <div className="flex items-center justify-between">
        <div className="text-sm font-medium">
          Content Detail : {table.contentName}
        </div>
...
export default ContentDetailTableEditor;